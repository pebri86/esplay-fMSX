...
#define I2C_QWERTY_MASTER_SDA_IO 21
#define I2C_QWERTY_MASTER_SCL_IO 22
...
bool odroid_qwerty_read(odroid_qwerty_state* keys)
{
    ...
    if (keyInt) {
        ...
        if (keyOverflow) {
            ...
            if(key & 0x80) odroid_qwerty_pressKey(key&0x7F);
            else odroid_qwerty_releaseKey(key&0x7F);
            changed = true;
...
char odroid_qwerty_key_to_ascii(uint8_t key, bool shift) {
    if (shift) switch (key) {
        case ODROID_QWERTY_TILDE:
            return '~';
        case ODROID_QWERTY_1:
            return '!';
        case ODROID_QWERTY_2:
            return '@';
        case ODROID_QWERTY_3:
            return '#';
        case ODROID_QWERTY_4:
            return '$';
        case ODROID_QWERTY_5:
            return '%';
        case ODROID_QWERTY_6:
            return '^';
        case ODROID_QWERTY_7:
            return '&';
        case ODROID_QWERTY_8:
            return '*';
        case ODROID_QWERTY_9:
            return '(';
        case ODROID_QWERTY_0:
            return ')';
        case ODROID_QWERTY_ESC:
            return 0x1b;
        case ODROID_QWERTY_Q:
            return 'Q';
        case ODROID_QWERTY_W:
            return 'W';
        case ODROID_QWERTY_E:
            return 'E';
        case ODROID_QWERTY_R:
            return 'R';
        case ODROID_QWERTY_T:
            return 'T';
        case ODROID_QWERTY_Y:
            return 'Y';
        case ODROID_QWERTY_U:
            return 'U';
        case ODROID_QWERTY_I:
            return 'I';
        case ODROID_QWERTY_O:
            return 'O';
        case ODROID_QWERTY_P:
            return 'P';
//      case ODROID_QWERTY_CTRL: return 0x00;
        case ODROID_QWERTY_A:
            return 'A';
        case ODROID_QWERTY_S:
            return 'S';
        case ODROID_QWERTY_D:
            return 'D';
        case ODROID_QWERTY_F:
            return 'F';
        case ODROID_QWERTY_G:
            return 'G';
        case ODROID_QWERTY_H:
            return 'H';
        case ODROID_QWERTY_J:
            return 'J';
        case ODROID_QWERTY_K:
            return 'K';
        case ODROID_QWERTY_L:
            return 'L';
        case ODROID_QWERTY_BS:
            return 0x08;
//      case ODROID_QWERTY_ALT: return 0x00;
        case ODROID_QWERTY_Z:
            return 'Z';
        case ODROID_QWERTY_X:
            return 'X';
        case ODROID_QWERTY_C:
            return 'C';
        case ODROID_QWERTY_V:
            return 'V';
        case ODROID_QWERTY_B:
            return 'B';
        case ODROID_QWERTY_N:
            return 'N';
        case ODROID_QWERTY_M:
            return 'M';
        case ODROID_QWERTY_BACKSLASH:
            return 0x5C;
        case ODROID_QWERTY_ENTER:
            return '\n';

//        case ODROID_QWERTY_SHIFT: return 0x00;
        case ODROID_QWERTY_SEMICOLON:
            return ':';
        case ODROID_QWERTY_QUOT:
            return '"';
        case ODROID_QWERTY_DASH:
            return '_';
        case ODROID_QWERTY_EQUAL:
            return '+';
        case ODROID_QWERTY_SPACE:
            return ' ';
        case ODROID_QWERTY_COMMA:
            return '<';
        case ODROID_QWERTY_POINT:
            return '>';
        case ODROID_QWERTY_SLASH:
            return '?';
        case ODROID_QWERTY_BRACKET_OPEN:
            return '{';
        case ODROID_QWERTY_BRACKET_CLOSE:
            return '}';
